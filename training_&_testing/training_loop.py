    ...
    def training(self):
        ...
        try:
            if self.patience != None:
                ...
                x = 0
            last_saved_model_epoch = len(self.validation_history['loss']) - x
            files.download('./model_epoch{}.pt'.format(last_saved_model_epoch)) 
        except:
            pass #in case the last saved epoch is closer to self.epoch than self.patience epochs
                 #to write this part better and delete pass statement
