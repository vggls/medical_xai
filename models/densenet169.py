...
The "DenseNet169" class is the source DenseNet class with the following modifications in the network structure:
    1. The following attributes are initialized as follows according to "line 422" of the source code:
      growth_rate: int = 32,
      block_config: Tuple[int, int, int, int] = (6, 12, 32, 32),
      num_init_features: int = 64
    2. The last BatchNorm2d feature layer is removed
    3. The GAP layer is removed (a Flatten layer connects the last Conv2d layer with the raw class scores instead)

The" _DenseNet169_" class is a custom written class which defines a "DenseNet169" instance and loads the pretrained 
...
model = _DenseNet169_(num_classes=4,
...
class DenseNet169(nn.Module):
    ...
    def __init__(self, 
        ...
        self.classifier = nn.Linear(1664*7*7, self.num_classes)   # <-- NEW
...
# use below class to instantiate a model
class _DenseNet169_():
    ...
    def __init__(self,
        ...
        self.model = DenseNet169(num_classes=self.no_of_classes)
