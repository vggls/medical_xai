...
The "DenseNet121" class is the source DenseNet class with the following modifications in the network structure:
    1. The following attributes are initialized as follows according to "line 370" of the source code:
      growth_rate: int = 32,
