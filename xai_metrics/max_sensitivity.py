...
def get_explanation(X, label, cam_instance):
...
def MaxSensitivity_Dataset(dataset, model, cam_instance, radius, iterations):
    ...
    for image, label in dataset:
            ...
            if real_label == pred_label:
                ...
                expl = get_explanation(image.unsqueeze(0), real_label, cam_instance)
                score = get_exp_sens(image.unsqueeze(0), real_label, expl, cam_instance, radius, iterations)
